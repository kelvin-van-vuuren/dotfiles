...
$copy_to_clipboard ~/.ssh/id_ed25519.pub

$open_webpage https://github.com/account/ssh
...
echo "If you need to copy the key again then open a new terminal and run: $copy_to_clipboard ~/.ssh/id_ed25519.pub"
